...
<head>
  ...
  <title>Inscription - La Guarrigue</title>
</head>

<body class="d-flex flex-column justify-content-between align-items-center h-100">
  <?php require_once('../config/header.php') ?>
  <main class="container p-4 rounded-lg w-25" id="maininsc">
    <form action="inscription.php" method="POST">
      ...
      <button type="submit" name="submit" class="btn btn-dark">Valider mon inscription</button>
    </form>
